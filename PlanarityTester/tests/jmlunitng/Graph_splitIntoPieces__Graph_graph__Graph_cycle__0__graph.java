 ...
 * test values for parameter "Graph graph" 
 * of method "java.util.Set splitIntoPieces(Graph, Graph)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2017-10-21 23:19 -0400
 */
public /*@ nullable_by_default */ class Graph_splitIntoPieces__Graph_graph__Graph_cycle__0__graph
   ...
   * "Graph graph" of method "java.util.Set splitIntoPieces(Graph, Graph)" 
   ...
   */
  public Graph_splitIntoPieces__Graph_graph__Graph_cycle__0__graph() {
    super();
