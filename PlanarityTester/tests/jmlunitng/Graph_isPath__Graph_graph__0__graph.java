 ...
 * of method "boolean isPath(Graph)". 
 * 
 * @author JMLUnitNG 1.4 (116/OpenJML-20131218-REV3178)
 * @version 2017-10-21 23:19 -0400
 */
public /*@ nullable_by_default */ class Graph_isPath__Graph_graph__0__graph
   ...
   * "Graph graph" of method "boolean isPath(Graph)" 
   ...
   */
  public Graph_isPath__Graph_graph__0__graph() {
    super();
